 ...
 */
function ipress_profile_install_tasks_alter(&$tasks, &$install_state) {
  $new_tasks = array(
    ...
    'install_configure_form' => array(
      ...
      'function' => 'md_install_configure_form',
      'type' => 'form',
    ),
 ...
 */
function md_install_configure_form_validate($form, &$form_state) {
 ...
 */
function md_install_configure_form_submit($form, &$form_state) {
  global $user;
...
function md_install_configure_form($form, &$form_state, &$install_state) {
...
function md_install_selected_profile() {
  ...
  if ($driver == 'mysql') {
    ...
    $success = md_import_database($file_name, $prefix, $connection);
...
function md_import_database($file_name, $prefix, $connection) {
  try {
