jQuery(document).ready(function ($) {
	...
	$('#version').change(function(){
		...
		if( version == 'light' ){
			...
			$('.versionss').html('<link rel="stylesheet" type="text/css" href="sites/all/themes/ipress/styles/dark.css" id="dark" media="screen" />');
			$('.logo a').html('<img src="sites/all/themes/ipress/images/logo_dark.png">');
		}
		$(window).trigger('resize');
	});
